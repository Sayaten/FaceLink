...
public class ComparisonSimilarity {
	...
	public static ArrayList<ImageSimilarity> getSimilarImage(String sample, String dir){
		...
		try{
			...
			for(int i = 0 ; i < pics.length ; ++i){
				if(pics[i].compareTo(dir + sample) == 0){
					temp = pics[0];
					pics[0] = pics[i];
					pics[i] = temp;
				}
